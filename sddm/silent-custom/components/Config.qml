...
QtObject {
    ...
    property string backgroundFillMode: config.stringValue("background-fill-mode") || "fill" // @possible:'fill' | 'fit' | 'stretch' @desc:Fill mode for background images. 'fill' crops to fill, 'fit' scales to fit without cropping, 'stretch' stretches to fill.
    ...
    property string lockScreenBackground: config.stringValue("LockScreen/background") || "default.jpg" // @possible:File in `backgrounds/` @desc:Background image of the lock screen. Supported formats: jpg, png.
    ...
    property string lockMessageIcon: config.stringValue("LockScreen.Message/icon") || "enter-key.svg" // @possible:File in `icons/` @desc:Icon above the custom message.
    ...
    // [LoginScreen]
    property string loginScreenBackground: config.stringValue("LoginScreen/background") || "default.jpg" // @possible:File in `backgrounds/` @desc:Background image of the login screen. Supported formats: jpg, png.
